...
const BENEFITS = [
  {
    ...
    desc: "Turn waste into biogas, fertilizer, and animal feed products",
    stat: "Up to 40% ROI"
  },
  {
    icon: Shield,
    title: "Environmental Compliance",
    desc: "Meet regulatory requirements and reduce environmental liability",
    stat: "100% Compliant"
  },
  {
    icon: Zap,
    title: "Energy Independence",
    desc: "Generate your own clean energy for farm operations",
    stat: "Reduce costs by 60%"
  },
  {
    icon: Globe,
    title: "Carbon Credits",
    desc: "Generate verified carbon offsets from waste reduction",
    stat: "Earn $15-25/tCO₂"
  }
];
...
const PROCESS_STEPS = [
  {
    ...
    desc: "Crop residue, manure, and processing waste are collected and sorted",
    details: "Efficient collection systems for farms of all sizes"
  },
  {
    icon: FlaskConical,
    title: "Processing & Digestion",
    desc: "Organic matter is broken down through anaerobic digestion",
    details: "85-90% conversion efficiency"
  },
  {
    icon: Droplets,
    title: "Biogas Production",
    desc: "Methane-rich biogas is captured and upgraded for use",
    details: "120m³ biogas per tonne of waste"
  },
  {
    icon: Sprout,
    title: "Fertilizer & Output",
    desc: "Digestate becomes high-quality organic fertilizer",
    details: "Rich in nitrogen, phosphorus, and potassium"
  }
];

const CASE_STUDIES = [
  {
    farm: "Great Lakes Farms",
    location: "Kisumu, Kenya",
    wasteType: "Crop Residue & Manure",
    reduction: "92%",
    energySaved: "1.8M kWh",
    image: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=800&q=85"
  },
  {
    farm: "Nakuru Green Farms",
    location: "Nakuru, Kenya",
    wasteType: "Maize Stover & Animal Waste",
    reduction: "78%",
    energySaved: "1.2M kWh",
    image: "https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=85"
  },
  {
    farm: "Tana River Agro",
    location: "Tana River, Kenya",
    wasteType: "Rice Husks & Farm Residue",
    reduction: "85%",
    energySaved: "2.1M kWh",
...
const TESTIMONIALS = [
  {
    quote: "ReVive Energy transformed our farm waste problem into a profit center. We now generate our own power and sell excess biogas to the grid.",
    name: "James Ochieng",
    role: "Farm Manager, Great Lakes Farms",
    image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=200&q=80"
  },
  {
    quote: "The fertilizer from our digestion system has improved crop yields by 30%. We're producing more food with less waste.",
    name: "Grace Muthoni",
    role: "Head Agronomist, Nakuru Green Farms",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 mb-6">
                ...
                <span className="text-xs font-bold tracking-wider text-[#11402D] uppercase">Agricultural Waste Solution</span>
              </div>
              ...
              <h1 className="font-serif-display text-5xl sm:text-6xl lg:text-7xl text-[#0A1A0F] leading-[1.1] tracking-tight mb-6">
                ...
                <span className="relative inline-block mx-3">
                  <span className="relative z-10 text-[#11402D]">profit.</span>
              ...
              <p className="text-xl text-[#5A7060] leading-relaxed mb-8">
                Convert agricultural residue, crop waste, and animal manure into biogas, organic fertilizer, and renewable energy — creating new revenue streams for farmers and agribusinesses.
              </p>
              ...
              {/* Stats */}
              <div className="grid grid-cols-3 gap-6 mt-10 pt-8 border-t border-[#11402D]/10">
                {[
                  { value: "85%", label: "Conversion Efficiency" },
                  { value: "120", label: "m³/T Biogas Yield" },
                  { value: "100T", label: "Daily Capacity" },
                ].map((stat, i) => (
                  <motion.div 
                    key={i}
                  ...
                  >
                    <div className="font-bold text-lg text-[#11402D]">{stat.value}</div>
                    <div className="text-xs text-[#5A7060]">{stat.label}</div>
                  </motion.div>
                ))}
              </div>
            </motion.div>
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-xl p-4 border border-[#11402D]/5">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#11402D] flex items-center justify-center">
                    <Wheat className="w-5 h-5 text-[#9CF06B]" />
                  </div>
                  <div>
                    <div className="font-bold text-[#0A1A0F]">500+ Farms</div>
                    <div className="text-xs text-[#5A7060]">Partnered across Africa</div>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xs font-bold tracking-wider text-[#11402D] uppercase">Overview</span>
              </div>
              <h2 className="font-serif-display text-4xl sm:text-5xl text-[#0A1A0F] mb-4">
                Agricultural waste is a hidden resource
              </h2>
              <p className="text-lg text-[#5A7060] leading-relaxed mb-6">
                Every year, millions of tonnes of agricultural residue are burned or left to decompose, releasing methane and contributing to climate change. Our solutions capture this value.
              </p>
              <p className="text-[#5A7060] leading-relaxed">
                We help farmers and agribusinesses transform crop residue, animal manure, and processing waste into biogas for cooking and electricity, high-quality organic fertilizer, and carbon credits.
              </p>
            </motion.div>
            ...
            >
              {[
                { icon: Crop, label: "Crop Residue", value: "Maize, Wheat, Rice" },
                { icon: Tractor, label: "Animal Manure", value: "Cattle, Poultry, Swine" },
                { icon: Sprout, label: "Processing Waste", value: "Husks, Stovers, Bagasse" },
                { icon: Flower2, label: "Other Organics", value: "Green waste, Kitchen waste" },
              ].map((item, i) => (
                <motion.div
                  key={i}
                  ...
                  className="bg-white rounded-xl p-4 border border-[#11402D]/5 text-center hover:shadow-md transition-all"
                >
                  <item.icon className="w-8 h-8 text-[#11402D] mx-auto mb-2" />
                  <div className="font-bold text-sm text-[#0A1A0F]">{item.label}</div>
                  <div className="text-xs text-[#5A7060]">{item.value}</div>
                </motion.div>
              ))}
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <h2 className="font-serif-display text-4xl sm:text-5xl text-[#0A1A0F] mb-4">
              Why Convert Agricultural Waste?
            </h2>
            <p className="text-lg text-[#5A7060]">
              Transform waste into multiple revenue streams
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {BENEFITS.map((benefit, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="bg-[#F6F8F4] rounded-2xl p-6 hover:shadow-xl transition-all group"
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-[#11402D] flex items-center justify-center flex-shrink-0 group-hover:bg-[#0A1A0F] transition-colors">
                    <benefit.icon className="w-6 h-6 text-[#9CF06B]" />
                  </div>
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <h3 className="font-bold text-[#0A1A0F]">{benefit.title}</h3>
                      <span className="text-xs font-bold text-[#11402D] bg-white px-2 py-0.5 rounded-full">
                        {benefit.stat}
                      </span>
                    </div>
      ...
      <section className="py-24 bg-[#F6F8F4]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-lg text-[#5A7060]">
              Simple process from farm waste to valuable products
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {PROCESS_STEPS.map((step, i) => (
              ...
              >
                <div className="bg-white rounded-2xl p-6 text-center hover:shadow-xl transition-all border border-[#11402D]/5">
                  <div className="w-16 h-16 rounded-full bg-[#11402D] flex items-center justify-center mx-auto mb-4 group-hover:bg-[#0A1A0F] transition-colors">
                    <step.icon className="w-8 h-8 text-[#9CF06B]" />
                  </div>
                  <div className="inline-block text-xs font-bold text-[#9CF06B] bg-[#11402D] px-2 py-0.5 rounded-full mb-3">
                    Step {i + 1}
                  </div>
                  <h3 className="font-bold text-[#0A1A0F] mb-2">{step.title}</h3>
                  <p className="text-sm text-[#5A7060] mb-2">{step.desc}</p>
      ...
      <section className="py-20 bg-[#11402D]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: 125000, suffix: "T", label: "Waste Processed" },
              { value: 850, suffix: " GWh", label: "Energy Generated" },
              { value: 45000, suffix: "T", label: "CO₂ Reduced" },
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-lg text-[#5A7060]">
              Real results from farms across Africa
            </p>
          </motion.div>
            ...
            {CASE_STUDIES.map((study, i) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  <img src={study.image} alt={study.farm} className="w-full h-full object-cover" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0A1A0F]/60 via-transparent to-transparent" />
                  <div className="absolute bottom-3 left-3 right-3">
                    <h3 className="text-white font-bold text-lg">{study.farm}</h3>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-[#11402D]/10">
                    <div>
                      <div className="text-xs text-[#5A7060]">Reduction</div>
      ...
      <section className="py-24 bg-[#F6F8F4]">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-lg text-[#5A7060]">
              Real experiences from our farming partners
            </p>
          </motion.div>
            ...
            {TESTIMONIALS.map((testimonial, i) => (
              ...
              >
                <div className="flex items-center gap-4 mb-4">
                  ...
                  />
                  <div>
                    <h4 className="font-bold text-[#0A1A0F]">{testimonial.name}</h4>
                    <p className="text-sm text-[#5A7060]">{testimonial.role}</p>
                  </div>
                </div>
                <p className="text-[#5A7060] leading-relaxed italic">
                  "{testimonial.quote}"
                </p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          >
            ...
            <p className="text-lg text-[#5A7060]">
              Everything you need to know about agricultural waste solutions
            </p>
          </motion.div>
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div
                ...
                className="bg-[#F6F8F4] rounded-xl p-6 hover:shadow-md transition-all"
              >
                <h4 className="font-bold text-[#0A1A0F] mb-2">{faq.q}</h4>
                <p className="text-sm text-[#5A7060] leading-relaxed">{faq.a}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          ...
          >
            <div className="w-16 h-16 rounded-full bg-[#9CF06B]/10 flex items-center justify-center mx-auto mb-6">
              <Sprout className="w-8 h-8 text-[#9CF06B]" />
            </div>
            <h2 className="font-serif-display text-3xl sm:text-4xl text-white mb-4">
              Ready to turn your farm waste into profit?
            </h2>
            <p className="text-lg text-white/60 max-w-2xl mx-auto mb-8">
              Book a free waste assessment and discover how much value your agricultural waste can generate.
            </p>
