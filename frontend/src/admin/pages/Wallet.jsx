    ...
    <div className="min-h-screen bg-[#F8FAFC] font-['Inter']">
      ...
      <div className="max-w-7xl mx-auto p-4 lg:p-6 space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h2 className="font-display text-2xl lg:text-3xl font-bold text-gray-900">Wallet Management</h2>
            <p className="text-sm text-gray-500 mt-1">View and manage supplier & transporter wallets</p>
          </div>
          <button
                  ...
                  {transactions.map(t => (
                    <div key={t.id} className="py-3 flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs font-mono-cw text-gray-500">{formatDate(t.created_at)}</p>
                      </div>
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="text-center">
        ...
        <p className="mt-4 text-gray-500 font-display">Loading wallets...</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="text-center max-w-md">
        ...
        <h3 className="text-xl font-bold text-gray-900 font-display">Unable to load wallets</h3>
