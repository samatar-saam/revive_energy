...
export default function AdminMessages() {
  ...
  const fetchConversations = async () => {
    ...
    try {
      ...
      console.log('📦 Parsed conversations:', data.length);
  ...
  const fetchMessages = async (conversationId) => {
    try {
      ...
      console.log(`📦 Messages for ${conversationId}:`, data);
  ...
  const getParticipantDisplay = (conv) => {
    ...
    // Fallback: try to extract from conversation object
    return {
      name: conv.guest_name || 'Guest',
      email: conv.guest_email || 'guest@example.com',
      isGuest: true,
    };
  };
