    ...
    <div className="min-h-screen bg-[#F8FAFC] font-['Inter']">
      ...
      <div className="max-w-7xl mx-auto p-4 lg:p-6 space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h2 className="font-display text-2xl lg:text-3xl font-bold text-gray-900">Withdrawal Requests</h2>
            <p className="text-sm text-gray-500 mt-1">Approve or reject withdrawal requests from suppliers and transporters</p>
          </div>
          <button
              ...
              {paginated.length === 0 ? (
                ...
                paginated.map(w => (
                  <tr key={w.id} className="hover:bg-gray-50/50 transition">
                    <td className="px-4 py-3 font-mono-cw text-sm text-gray-500">#{w.id}</td>
                    <td className="px-4 py-3 text-sm text-gray-700">
                      {w.user_name}<br/><span className="text-xs text-gray-400">{w.email}</span>
                    </td>
                    ...
                    <td className="px-4 py-3 text-sm font-mono-cw text-gray-500">{formatDate(w.created_at)}</td>
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="text-center">
        ...
        <p className="mt-4 text-gray-500 font-display">Loading withdrawals...</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="text-center max-w-md">
        ...
        <h3 className="text-xl font-bold text-gray-900 font-display">Unable to load withdrawals</h3>
