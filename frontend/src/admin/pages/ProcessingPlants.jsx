    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-500 font-display">Loading processing plants...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-md">
          ...
          <h3 className="text-xl font-bold text-gray-900 font-display">Unable to load plants</h3>
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
          {paginatedPlants.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-700 font-display">No processing plants found</h3>
                ...
                <tbody className="divide-y divide-gray-100">
                  {paginatedPlants.map((plant) => (
                    <tr key={plant.id} className="hover:bg-gray-50/50 transition">
                      <td className="px-4 py-3 font-mono-cw text-sm text-gray-500">#{plant.id}</td>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
            <div className="w-full max-w-2xl rounded-3xl bg-white p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
              <div className="mb-5 flex items-start justify-between">
                <div>
                  <h2 className="font-display text-xl font-bold text-gray-900">Plant Details</h2>
                  <p className="text-sm text-gray-500 font-mono-cw">ID #{selectedPlant.id}</p>
                </div>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm font-mono-cw text-gray-700">{formatDate(selectedPlant.created_at)}</p>
                  </div>
                </div>
              </div>
        ...
        {showEditModal && selectedPlant && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
            <div className="w-full max-w-2xl rounded-3xl bg-white p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
              <div className="mb-5 flex items-start justify-between">
                <div>
                  <h2 className="font-display text-xl font-bold text-gray-900">Edit Plant</h2>
                  <p className="text-sm text-gray-500 font-mono-cw">ID #{selectedPlant.id}</p>
                </div>
                <button onClick={closeModals} className="rounded-xl p-2 hover:bg-gray-100">
                  <X className="h-5 w-5 text-gray-500" />
        ...
        {showAddModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
            <div className="w-full max-w-2xl rounded-3xl bg-white p-6 shadow-2xl max-h-[90vh] overflow-y-auto">
              <div className="mb-5 flex items-start justify-between">
                <div>
                  <h2 className="font-display text-xl font-bold text-gray-900">Add Processing Plant</h2>
