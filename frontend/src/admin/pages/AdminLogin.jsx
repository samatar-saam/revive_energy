    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center px-4 py-10 relative">
      <style>
        {`
          ...
          /* ── Toastify styling (same as main Login) ── */
          .Toastify__toast {
        ...
        <div className="hidden lg:flex relative bg-gradient-to-br from-[#0E2A1C] via-[#11402D] to-[#1a5c3e] p-10 text-white flex-col justify-between">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-3 rounded-2xl bg-white/10 px-4 py-3 backdrop-blur-sm border border-white/20">
              ...
              <span className="font-display font-semibold text-lg">Admin Portal</span>
            </div>
            <div className="mt-12">
              <p className="font-mono-cw text-sm uppercase tracking-[0.25em] text-green-200">Secure Access</p>
          ...
          <div className="relative z-10 grid grid-cols-2 gap-4 mt-8">
            ...
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm border border-white/20">
              <p className="font-display text-2xl font-bold">318+</p>
              <p className="text-sm text-green-200">Companies</p>
            </div>
            <div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm border border-white/20">
              <p className="font-display text-2xl font-bold">89</p>
          ...
          <div className="relative z-10 mt-6 space-y-2.5">
            <div className="flex items-center gap-3 text-sm text-green-200">
              <Shield className="w-4 h-4 text-[#9CF06B]" /><span>Two‑factor authentication</span>
            </div>
            <div className="flex items-center gap-3 text-sm text-green-200">
              <Lock className="w-4 h-4 text-[#9CF06B]" /><span>Encrypted data transmission</span>
            </div>
            <div className="flex items-center gap-3 text-sm text-green-200">
              <CheckCircle className="w-4 h-4 text-[#9CF06B]" /><span>Real‑time security monitoring</span>
            </div>
            <div className="flex items-center gap-3 text-sm text-green-200">
              <Users className="w-4 h-4 text-[#9CF06B]" /><span>Full user management</span>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleLogin} className="mt-6 space-y-4">
              ...
              <div>
                ...
                <div className="mt-2 text-right">
                  <Link to="/admin/forgot-password" className="text-sm text-green-600 hover:text-green-700 font-medium">
                    Forgot password?
                  </Link>
                </div>
              </div>
