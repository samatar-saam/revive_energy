    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-md">
          ...
          <h3 className="text-xl font-bold text-gray-900">Unable to load tickets</h3>
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
        {paginatedTickets.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-700">No support tickets found</h3>
              ...
              <tbody className="divide-y divide-gray-100">
                {paginatedTickets.map((ticket) => (
                  <tr key={ticket.id} className="hover:bg-gray-50/50 transition">
                    <td className="px-4 py-3 font-mono text-sm text-gray-500">#{ticket.id}</td>
