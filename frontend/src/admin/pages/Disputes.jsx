  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Disputes Management</h2>
          <p className="text-sm text-gray-500">Resolve conflicts between suppliers, producers, and transporters</p>
        </div>
        <button
            ...
            {disputes.length === 0 ? (
              ...
              disputes.map((d) => (
                <tr key={d.id} className="hover:bg-gray-50/50 transition">
                  ...
                  <td className="px-4 py-3 font-mono text-sm text-gray-500">#{d.payment_id}</td>
    ...
    <div className="fixed inset-0 z-50 flex items-start justify-end bg-black/30">
      <div className="relative h-full w-full max-w-2xl bg-white shadow-2xl overflow-y-auto animate-slide-in-right">
        <div className="sticky top-0 z-10 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
          <h2 className="text-xl font-bold text-gray-900">Dispute Details #{dispute.id}</h2>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="mt-1 font-mono text-sm">#{dispute.payment_id}</p>
            </div>
            <div>
          ...
          {/* Complaint & Evidence */}
          <div className="border-t border-gray-100 pt-4">
            <h3 className="font-semibold text-gray-700 mb-2">Complaint</h3>
