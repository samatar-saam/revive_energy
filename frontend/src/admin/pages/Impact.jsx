...
export default function AdminImpactReports() {
  ...
  const formatNumber = (num) => {
    ...
    if (num >= 1000) {
      return num.toLocaleString('en-KE', { maximumFractionDigits: 1 });
    }
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh] font-['Inter']">
        <div className="text-center max-w-md">
          ...
          <h3 className="text-xl font-bold text-gray-900 font-display">Unable to load impact data</h3>
    ...
    <div className="min-h-screen bg-[#F8FAFC] font-['Inter']">
      ...
      <div className="max-w-7xl mx-auto p-4 lg:p-6 space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h2 className="font-display text-2xl lg:text-3xl font-bold text-[#0E2A1C]">Impact Reports</h2>
            <p className="text-sm text-gray-500 mt-1">Environmental impact metrics and reports</p>
          </div>
          <div className="flex items-center gap-3">
            ...
            <button className="inline-flex items-center gap-2 rounded-xl bg-[#11402D] px-4 py-2 text-sm font-bold text-white hover:bg-[#0E2A1C] transition shadow-sm">
