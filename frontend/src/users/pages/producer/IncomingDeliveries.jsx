...
export default function IncomingDeliveries() {
  ...
  const fetchDeliveries = async () => {
    ...
    try {
      ...
      // Data is already an array of transport jobs
  ...
  // ─── Action handlers (placeholder – you can wire these to real endpoints) ──
...
function DetailModal({ delivery, onClose, onAction }) {
  ...
  // Mock map placeholder (you can integrate Google Maps later)
        ...
        <div className="p-6 space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gray-50 rounded-2xl p-4">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p><span className="text-gray-500">Phone:</span> {delivery.supplier_phone || "N/A"}</p>
                ...
                <div className="bg-gray-50 rounded-2xl p-4">
                  ...
                  <div className="space-y-1 text-sm">
                    ...
                    <p><span className="text-gray-500">Phone:</span> {delivery.transporter_phone || "N/A"}</p>
                  </div>
                </div>
          ...
          <div className="border-t border-gray-100 pt-6 flex flex-wrap gap-3">
            {delivery.status === "open" && (
              <button className="bg-[#11402D] text-white px-4 py-2 rounded-xl text-sm font-bold hover:bg-[#0E2A1C] transition flex items-center gap-2">
            ...
            {["accepted", "picked_up", "in_transit"].includes(delivery.status) && (
              <>
                ...
                <button className="border border-gray-200 px-4 py-2 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition flex items-center gap-2">
            ...
            {delivery.status === "delivered" && (
              <>
                <button
                  onClick={() => onAction("accept", delivery.id)}
                ...
                <button
                  onClick={() => onAction("report", delivery.id)}
