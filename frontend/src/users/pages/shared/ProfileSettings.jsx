...
import {
  ...
  Camera, X, Upload, ChevronRight, Shield, Trash2,
  Eye, EyeOff, Check, Video, StopCircle,
...
export default function ProfileSettings() {
  ...
  const displayAv = tempAvatar || profile.avatar;
  ...
  return (
    <div className="min-h-screen bg-[#F6F8F4] text-[#0A1A0F]" style={{ fontFamily:"'Inter',sans-serif" }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Inter:wght@400;500;600;700;900&family=JetBrains+Mono:wght@400;500&display=swap');
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 lg:py-12">
        ...
        <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }}
          className="relative bg-[#0A1A0F] rounded-3xl overflow-hidden mb-8">
          {/* Mosaic background texture */}
          ...
          <div className="relative px-6 sm:px-10 py-10 flex flex-col sm:flex-row items-center sm:items-start gap-7">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <div className="flex items-center justify-center sm:justify-start gap-2 mb-3">
                <div className="text-[10px] font-bold tracking-[0.22em] uppercase text-white/30 font-mono">
                  {profile.role || 'User'}
                </div>
                <span className="w-1.5 h-1.5 rounded-full bg-[#9CF06B] animate-pulse"/>
              </div>
              {/* Name */}
              <h1 className="font-serif text-4xl sm:text-5xl text-white leading-tight mb-2">
            ...
            <button onClick={() => { setActiveTab('profile'); formRef.current?.scrollIntoView({ behavior:'smooth' }); }}
              className="flex-shrink-0 flex items-center gap-2 text-sm font-bold text-[#0A1A0F] px-5 py-2.5 rounded-xl self-start"
              style={{ background:'#9CF06B' }}>
            ...
            {[
              ...
              <div key={i} className={`px-5 py-4 flex items-center gap-3 ${i < 3 ? 'border-r border-white/6' : ''}`}>
                ...
                <div className="min-w-0">
                  <div className="text-[9px] text-white/25 font-mono uppercase tracking-widest mb-0.5">{s.label}</div>
        ...
        {/* ── TAB BAR ── */}
        <div className="flex gap-1 bg-white border border-[#E5EDE8] rounded-2xl p-1 mb-6">
          {TABS.map(tab => (
          ...
          {activeTab === 'profile' && (
            <motion.div key="profile" ref={formRef}
              ...
              <form onSubmit={handleSaveProfile}>
                <div className="bg-white rounded-2xl border border-[#E5EDE8] overflow-hidden">
                  <div className="px-6 py-5 border-b border-[#F0F5F2]">
                    <h2 className="font-serif text-xl text-[#0A1A0F]">Personal Information</h2>
              ...
              <form onSubmit={handleSavePassword}>
                <div className="bg-white rounded-2xl border border-[#E5EDE8] overflow-hidden">
                  <div className="px-6 py-5 border-b border-[#F0F5F2] flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="font-serif text-xl text-[#0A1A0F]">Change Password</h2>
